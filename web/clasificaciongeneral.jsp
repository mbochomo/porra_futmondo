...
<%@page contentType="text/html" pageEncoding="UTF-8" import="java.util.ArrayList"
        import="es.porrafutmondo.badajoz.JugadorClasificacion"%>
<!DOCTYPE html>
<html>
    <head>
        <title>INICIO</title>
    ...
    <body>
        ...
        <div class="contenedor-res">
            <table class ="tabla-apuesta">
                ...
                <%
                    ArrayList<JugadorClasificacion> clasificacion = (ArrayList) session.getAttribute("clasificacion");
                    int i = 1;
                    for(JugadorClasificacion JC: clasificacion){
                        out.println("<tr>");
                        out.println("<th>"+i+"</th>");
