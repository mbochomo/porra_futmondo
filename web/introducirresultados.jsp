...
<html>
    ...
    <body>
            ...
            <div class ="contenedor">
                ...
                <nav class="menu">
                    <a href="#"><%
                        ...
                        if (us != null) {
                            out.println("<a href='insertarjornada.jsp' class='active'>Nueva jornada</a>");
                            out.println("<a href=''>Introducir resultados</a>");
        ...
        <div class="contenedor-res">
            <form action="ComprobarResultados" method="post">
                <table class="tabla">                  
                    <%
